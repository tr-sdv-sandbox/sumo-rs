...
use suit_codec::commands::{CommandSequence, CommandValue};
use suit_codec::envelope::SuitEnvelope;
use suit_codec::labels::*;
use suit_codec::parameters::ParameterValue;
use suit_codec::types::{DigestInfo, Uuid, VersionMatch};
...
impl Manifest {
    ...
    fn find_param(
        ...
        component: usize,
        param_label: i64,
    ) -> Option<&suit_codec::parameters::SuitParameter> {
        find_param_in_seq(
    ...
    fn text_component_field<'a>(
        &'a self,
        component: usize,
        f: impl Fn(&'a suit_codec::text::TextComponent) -> Option<&'a str>,
    ) -> Option<&'a str> {
        self.envelope
            .manifest
            .severable
...
fn find_param_in_seq<'a>(
    ...
    component: usize,
    param_label: i64,
) -> Option<&'a suit_codec::parameters::SuitParameter> {
